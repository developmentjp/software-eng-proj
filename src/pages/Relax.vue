<template>
	<section>
		<h1 class="title">Relaxer Yourself, Breath</h1>
		<div class="container" id="container" :class="{ grow: containerGrow, shrink: containerShrink }">
...
.gradient-circle {
	background: conic-gradient(#b3cde0 0%, #6497b1 40%, #fff 40%, #fff 60%, #03396c 60%, #011f4b 100%);
	height: 320px;
	width: 320px;
	z-index: -2;
	border-radius: 50%;

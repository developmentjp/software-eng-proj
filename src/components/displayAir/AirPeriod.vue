<template>
	<div class="container">
		...
		<div class="dominant">
			...
			<span style="text-align:center;display: flex; align-items:center; margin-left:0.25rem">
				<i @click="search" class="pi pi-question-circle" style="font-size: 1rem; cursor: pointer;"></i>
			</span>
		</div>
		...
		<Dialog v-model:visible="display">
			...
			<template #footer>
				<Button class="p-button-secondary" label="Ok" icon="pi pi-check" autofocus @click="closeSearch" />
			</template>
		</Dialog>
	</div>
</template>
